...
namespace DG.Tweening.TimelineEditor
{
    ...
    {
        [MenuItem("GameObject/DOTween/Timeline → DOTweenClipCollection", false, 20)]
        static void CreateDOTweenClipCollection(MenuCommand menuCommand)
        {
            GameObject go = new GameObject("DOTweenClipCollection");
            go.AddComponent<DOTweenClipCollection>();
