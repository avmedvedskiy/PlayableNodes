...
namespace DG.Tweening.Timeline.Core.Plugins
{
    public class PlugDataAction : IPluginData
    {
        ...
        public Type objOptionType { get; private set; } // Set to eventually interpret intOption as enum
        ...
        public readonly Action<object, bool, string, Object, float, float, float, float, int> action;
        public readonly Action<object, bool, string, Object, float, float, float, float, int> onCreation;

        /// <summary>
        /// IMPORTANT: if you want to pass an optional object you must set both <see cref="objOptionType"/> and <see cref="objOptionLabel"/>,
        /// and <see cref="objOptionType"/> must be of type <see cref="Object"/>
        /// </summary>
        public PlugDataAction(
            string guid, string label, Type targetType,
            Action<object, bool, string, Object, float, float, float, float, int> action,
            Action<object, bool, string, Object, float, float, float, float, int> onCreation = null,
            ...
            this.propertyType = DOTweenClipElement.PropertyType.Unset; // Unused
            this.label = label;
            ...
            this.objOptionType = objOptionType;
            this.objOptionLabel = objOptionLabel;
            this.action = action;
