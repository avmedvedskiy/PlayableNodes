...
namespace DG.Tweening.Timeline.Core.Plugins
{
    ...
    {
#if UNITY_EDITOR
        // Special events to communicate with Timeline editor code
        public static event Action<ParticleSystem> OnEditorRequestAddParticleSystemToEditorPreview;
        static void EditorDispatch_OnRequestAddParticleSystemToEditorPreview(ParticleSystem ps) { if (OnEditorRequestAddParticleSystemToEditorPreview != null) OnEditorRequestAddParticleSystemToEditorPreview(ps); }
#endif
        ...
        static DOVisualTweenPlugin GetTweenPlugin(Type targetType, string targetTypeFullName)
        {
...
#if UNITY_EDITOR
                        , onCreation: EditorAddParticleSystemToEditorPreview
#endif
                    ),
            ...
            case "UnityEngine.RectTransform":
                return DOVisualPluginsManager.CacheAndReturn(targetType,
                    ...
                    new PlugDataTween("2f8a04e3-2ec7-44b0-b305-dec15e0dca3d", "Shape/Circle", (c,s,i) => ()=> ((RectTransform)c).anchoredPosition, (c,s,i) => x => ((RectTransform)c).anchoredPosition = x, PluginTweenType.ShapeCircle),
                    // Transform-based
            ...
            case "UnityEngine.TextMesh":
                return DOVisualPluginsManager.CacheAndReturn(targetType,
                    new PlugDataTween("2a90c46c-906a-442e-9fff-7b48f11ddb11", "Color", (c,s,i) => ()=> ((TextMesh)c).color, (c,s,i) => x => ((TextMesh)c).color = x),
                    new PlugDataTween("39e47299-2699-48fa-83c8-fb235a5811b9", "Text", (c,s,i) => ()=> ((TextMesh)c).text, (c,s,i) => x => ((TextMesh)c).text = x),
                    new PlugDataTween("e087f90c-8a92-4954-a019-e44ea99b5185", "Font Size", (c,s,i) => ()=> ((TextMesh)c).fontSize, (c,s,i) => x => ((TextMesh)c).fontSize = x)
                );
            ...
            case "UnityEngine.UI.Image":
                return DOVisualPluginsManager.CacheAndReturn(targetType,
                    new PlugDataTween("c9b92866-07ab-41d5-98c6-cecd65151c70", "Color", (c,s,i) => ()=> ((Image)c).color, (c,s,i) => x => {
                        ((Image)c).color = x;
#if UNITY_EDITOR
                        EditorPreviewUIFixer(c as Component);
#endif
                    }),
            ...
            case "UnityEngine.UI.Text":
                return DOVisualPluginsManager.CacheAndReturn(targetType,
                    new PlugDataTween("6b66dcc1-2a4f-48b2-9581-09c01959fb9d", "Color", (c,s,i) => ()=> ((Text)c).color, (c,s,i) => x => {
                        ((Text)c).color = x;
#if UNITY_EDITOR
                        EditorPreviewUIFixer(c as Component);
#endif
                    }),
                    new PlugDataTween("631f202c-1c47-40d4-b54d-61cd2d4b674b", "Text", (c,s,i) => ()=> ((Text)c).text, (c,s,i) => x => {
                        ((Text)c).text = x;
#if UNITY_EDITOR
                        EditorPreviewUIFixer(c as Component);
#endif
            ...
            case "TMPro.TextMeshProUGUI":
                return DOVisualPluginsManager.CacheAndReturn(targetType,
                    new PlugDataTween("002a6b63-4bc5-40e1-9957-c86fb6d3f686", "Color", (c,s,i) => ()=> ((TMP_Text)c).color, (c,s,i) => x => {
#if UNITY_EDITOR
                        EditorPreviewUIFixer(c as Component);
#endif
                        ((TMP_Text)c).color = x;
                    }),
                    new PlugDataTween("bbd5bf2c-fa54-4b54-a39f-a3494633c170", "Face Color", (c,s,i) => ()=> ((TMP_Text)c).faceColor, (c,s,i) => x => {
#if UNITY_EDITOR
                        EditorPreviewUIFixer(c as Component);
#endif
                        ((TMP_Text)c).fontMaterial.SetColor("_FaceColor", x);
                    }),
                    new PlugDataTween("8d9fee08-2fdf-4df3-9835-f2605491dffd", "Outline Color", (c,s,i) => ()=> ((TMP_Text)c).outlineColor, (c,s,i) => x => {
#if UNITY_EDITOR
                        EditorPreviewUIFixer(c as Component);
#endif
                        ((TMP_Text)c).fontMaterial.SetColor("_OutlineColor", x);
                    }),
                    new PlugDataTween("1c3cb4ef-91ce-40e5-85f6-786eb563f445", "Text", (c,s,i) => ()=> ((TMP_Text)c).text, (c,s,i) => x => {
#if UNITY_EDITOR
                        EditorPreviewUIFixer(c as Component);
#endif
                        ((TMP_Text)c).text = x;
                    }),
                    new PlugDataTween("f8c431c7-6da0-46f2-9b9e-4c923ba948f9", "Font Size", (c,s,i) => ()=> ((TMP_Text)c).fontSize, (c,s,i) => x => {
#if UNITY_EDITOR
                        EditorPreviewUIFixer(c as Component);
#endif
                        ((TMP_Text)c).fontSize = x;
                    }),
                    new PlugDataTween("264c77b6-7e6e-4ecd-b672-f76c04d9cdc2", "Max Visible Chars", (c,s,i) => ()=> ((TMP_Text)c).maxVisibleCharacters, (c,s,i) => x => {
#if UNITY_EDITOR
                        EditorPreviewUIFixer(c as Component);
#endif
                        ((TMP_Text)c).maxVisibleCharacters = x;
                    }, onCreation: RefreshTMPMaxVisibleCharsAndWords),
                    new PlugDataTween("01da2259-5125-46a6-be08-45129184bc4b", "Max Visible Words", (c,s,i) => ()=> ((TMP_Text)c).maxVisibleWords, (c,s,i) => x => {
#if UNITY_EDITOR
                        EditorPreviewUIFixer(c as Component);
#endif
                        ((TMP_Text)c).maxVisibleWords = x;
                    }, onCreation: RefreshTMPMaxVisibleCharsAndWords)
                );
#endif
            }
            ...
            if (targetType.IsSubclassOf(typeof(Graphic))) {
                return DOVisualPluginsManager.CacheAndReturn(targetType,
                    new PlugDataTween("f7e3b8ab-7a2e-450b-9934-8c48f9e5d0bd", "(Graphic)Color", (c,s,i) => ()=> ((Graphic)c).color, (c,s,i) => x => ((Graphic)c).color = x)
                ).IsSupportedViaSubtype("Graphic");
            }
#endif
            return null;
        }
        ...
        static void EditorAddParticleSystemToEditorPreview(object t, string s, int i)
        {
            if (t == null) return;
            EditorDispatch_OnRequestAddParticleSystemToEditorPreview((ParticleSystem)t);
        }
        ...
        static void RefreshTMPMaxVisibleCharsAndWords(object tmpObj, string stringOption, int intOption)
        {
            TMP_Text tmp = (TMP_Text)tmpObj;
            tmp.ForceMeshUpdate(true);
            tmp.maxVisibleCharacters = tmp.textInfo.characterCount;
            tmp.maxVisibleWords = tmp.textInfo.wordCount;
        }
