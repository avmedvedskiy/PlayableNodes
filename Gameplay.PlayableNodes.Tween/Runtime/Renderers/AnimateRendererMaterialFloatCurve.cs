...
{
    [Serializable]
    [MovedFrom(true, "PlayableNodes", "PlayableNodes.Runtime", "AnimateMeshRendererMaterialFloatCurve")]
    ...
    public class AnimateRendererMaterialFloatCurve : TweenAnimation<Renderer>
    {
