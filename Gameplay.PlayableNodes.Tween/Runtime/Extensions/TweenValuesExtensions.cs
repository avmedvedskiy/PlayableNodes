...
namespace PlayableNodes
{
    public static class TweenValuesExtensions
    {
        ...
        public static Tweener ChangeValuesVectorOnStart(this Tweener tween,  ToFromValue<float> to,  ToFromValue<float> from)
        {
            return tween.OnStart(() => tween.ChangeValuesVector(to, from));
        }
        
        public static Tweener ChangeValuesVectorOnStart(this Tweener tween,  ToFromValue<Vector3> to,  ToFromValue<Vector3> from)
        {
            return tween.OnStart(() => tween.ChangeValuesVector(to, from));
        }
        
        public static Tweener ChangeValuesVectorOnStart(this Tweener tween,  Vector3 to,  ToFromValue<Vector3> from)
        {
            var twCore = (TweenerCore<Vector3, Vector3, VectorOptions>)tween;
            return tween.OnStart(() => tween.ChangeValuesVector(to, from.ConvertValue(twCore.getter())));
        }
